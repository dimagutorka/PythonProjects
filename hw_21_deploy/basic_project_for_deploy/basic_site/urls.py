...
from basic_site.views import update_user_profile, home, genre_page_view, genres_page_view, movie_page_view, create_movie, rate_movie
...
urlpatterns = [
	...
	path('movie/<int:movie_id>/', rate_movie, name='rate'),
